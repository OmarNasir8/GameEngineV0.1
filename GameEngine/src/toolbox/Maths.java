...
public class Maths {
	...
	public static Matrix4f createTransformtionMatrix(Vector3f translation, float rx, float ry, float rz,float scale) {
	...
	public static Matrix4f createViewCamera(Camera camera) {
